...
// 		return ColorType(r,g,b,1.);
		...
		ScalarType r = huanyun_color_table[color_index][0]/255.0;
		ScalarType g = huanyun_color_table[color_index][1]/255.0;
		ScalarType b = huanyun_color_table[color_index][2]/255.0;
		return ColorType(r,g,b,1.);
